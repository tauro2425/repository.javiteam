...
def fanart(item):
    ...
    itemlist.append( Item(channel=__channel__, action="trailer", title=title , url=item.url , thumbnail=thumbnail , plot=trailer , fanart=fanart_trailer, extra=extra, folder=True) )
    return itemlist
